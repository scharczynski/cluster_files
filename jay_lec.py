...
def run_script(cell_range):
    ...
    # path_to_data = "/Users/stevecharczynski/workspace/data/jay/jay_LEC/"
    path_to_data = "/projectnb/ecog-eeg/stevechar/data/jay/lec/"
    # save_dir = "/Users/stevecharczynski/workspace/data/jay/jay_LEC/"
    save_dir = "/projectnb/ecog-eeg/stevechar/ml_runs/jay/lec/"
    # path_to_data = "/projectnb/ecog-eeg/stevechar/data/jay/jay_LEC/"
    ...
    pipeline = analysis.Pipeline(cell_range, data_processor, [
        "ConstVariable", "TimeVariableLength", "SigmaMuTauVariableLength"], save_dir=save_dir)
    # pipeline = analysis.Pipeline(cell_range, data_processor, [
    #     "ConstVariable", "RelPosVariable"], save_dir=save_dir)
