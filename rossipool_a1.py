...
def run_script(cell_range):
    ...
    # save_dir = "/Users/stevecharczynski/workspace/data/rossi_pool/a1/"
    save_dir = "/projectnb/ecog-eeg/stevechar/ml_runs/rossi_pool/a1/"
    path_to_data = "/projectnb/ecog-eeg/stevechar/data/rossi_pool/a1/"
    ...
    # with open("/Users/stevecharczynski/workspace/data/rossi_pool/a1/info.json") as f:
    with open("/projectnb/ecog-eeg/stevechar/data/rossi_pool/a1/info.json") as f:
        stims = json.load(f)
