...
def run_script(cell_range, session):
    ...
    # save_dir = "/projectnb/ecog-eeg/stevechar/sheehan_runs/final_dataset/lights1_move0/inbound/"
    # path_to_data = "/projectnb/ecog-eeg/stevechar/data/sheehan/final_dataset/lights1_move0/inbound/"
